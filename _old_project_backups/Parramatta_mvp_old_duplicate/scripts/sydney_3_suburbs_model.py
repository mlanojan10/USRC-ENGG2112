...
FEATURE_TABLE_FILE = PROCESSED_DIR / "sydney_3_suburbs_feature_table_night_cooling.csv"
...
# IMPORTANT:
# Your combine_era5_3_suburbs.py script should already convert UTC to Sydney local time.
# So this script does NOT convert timezone again.
# It treats datetime as already local Sydney time.
...
print(df_model[["suburb", "distance_to_coast_km", "distance_to_water_km", "is_coastal"]].head())
...
# This defines heat-event days relative to the whole study set.
...
disp.plot()
plt.title("Random Forest Confusion Matrix - 3 Suburbs")
plt.tight_layout()
...
plt.ylabel("Feature")
plt.title("Random Forest Feature Importance - 3 Suburbs")
...
print("\n==============================")
print("3-SUBURB NIGHT-TIME COOLING FAILURE MVP COMPLETE")
print("==============================")
...
print(
    ...
    "bottom 25% of hot-day cooling rates across the 3-suburb dataset."
)
...
print(
    "distance_to_coast_km, distance_to_water_km and is_coastal are merged from "
